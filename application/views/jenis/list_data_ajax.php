...
<table class="table datatable">
    ...
    <tr>
        ...
        <td><?php echo $records[$iRow]->id_jenis ?>
            <a class="fa fa-pencil" style="color:green;" href="<?php echo base_url('jenis/rubahJenis/'. $records[$iRow]->id_jenis) ?>"> </a>
            <a class="fa fa-remove" style="color:red;" href="<?php echo base_url('jenis/hapusJenis/'. $records[$iRow]->id_jenis) ?>"> </a></td>
        </td>
