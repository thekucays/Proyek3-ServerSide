...
<div class="row col-lg-12">
    <h1><?php echo "Jenis Bengkel" ?></h1>

    <div class="row col-lg-12">
        <a href="<?php echo base_url('jenis/tambahJenis') ?>" class="btn btn-primary"><i class="fa fa-plus"><?php echo lang('AddNew') ?></i></a>
    </div>
    <div>&nbsp;</div>
    <div>&nbsp;</div>
...
$(document).ready(function(){
    ...
    $(".searchdata").click(function(event){
        ...
        $.ajax({
            url : "<?php echo base_url('jenis/list_data_ajax') ?>",
