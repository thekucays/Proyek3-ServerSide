        ...
        <form name="search_form" id="search_form">
            ...
            <div class="form-inline">
                ...
                <?php                
                  ...
                  echo form_dropdown('isTubeless', $options_tb, '');
                ?>
            </div>
            <div>
                <label class=""> Jenis Bengkel </label>
                
                <?php                
                  $options_jenis = array(
                    '' => 'All',
                    'Bengkel Resmi' => 'Bengkel Resmi',
                    'Bengkel Kecil' => 'Bengkel Kecil'
                  );

                  echo form_dropdown('jenis', $options_jenis, '');
                ?>
            </div>
            <div class="row">&nbsp;</div>
...
$(document).ready(function(){
    ...
    $(".searchdata").click(function(event){
        ...
        $.ajax({
            url : "<?php echo base_url('bengkel/list_data_ajax') ?>",
